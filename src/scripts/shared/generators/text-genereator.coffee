@app.module 'shared.generators', (Generators, app, Backbone, Marionette, $, _) -> 
	class Generators.TextGenerator
		...
		#---------------------------------------- PRIVAT METHODS ----------------------------------------
		String.prototype.insertTo = (index, string) ->
			if (index > 0)
