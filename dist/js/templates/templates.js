(function (root, factory) {
    ...
    var templatizer = {};
    templatizer["cardsGenerator"] = {};
    templatizer["welcome"] = {};

    // 404.jade compiled template
    templatizer["404"] = function tmpl_404() {
        return '<h1 class="text-center">404<h2>Page not found</h2></h1>';
    };

    // cardsGenerator/card.jade compiled template
    templatizer["cardsGenerator"]["card"] = function tmpl_cardsGenerator_card() {
        return '<li class="card"><div class="card_perspective"><div class="card_perspective_inner_wrapper"><canvas resize="true" class="card_canvas front">HTML5 Canvas is not supported</canvas><canvas resize="true" class="card_canvas back">HTML5 Canvas is not supported</canvas></div></div></li>';
    };

    // cardsGenerator/cardsGreed.jade compiled template
    templatizer["cardsGenerator"]["cardsGreed"] = function tmpl_cardsGenerator_cardsGreed(locals) {
        var buf = [];
        var jade_mixins = {};
        var jade_interp;
        buf.push('<div id="cardsGreed"><ul class="cards">');
        for (var i = 1; i <= 25; i++) {
            if (i == 13) {
    ...
    // cardsGenerator/stepForm.jade compiled template
    templatizer["cardsGenerator"]["stepForm"] = function tmpl_cardsGenerator_stepForm() {
        return '<li class="card main_controller_wrapper"><div class="main_controller"><form action="/" class="main_controller_form q1"><div class="main_controller_form_label">Текст вопроса</div><div class="main_controller_form_input"></div><button type="submit" value="" class="main_controller_form_submit icon-arrow-right2"></button></form><div class="main_controller_form_statusbar"><div class="main_controller_form_statusbar_value"></div></div><div class="main_controller_form_statusbar_step"><span class="main_controller_form_statusbar_current"> </span>/  <span class="main_controller_form_statusbar_quantity"></span></div><div class="main_controller_form_controls"><div class="main_controller_form_control prev"><a class="icon-arrow-left"></a></div><div class="main_controller_form_control next"><a class="icon-arrow-right"></a></div></div></div></li>';
    };
