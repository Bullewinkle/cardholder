(function() {
  ...
  this.app.module('shared.generators.textGen', function(TextGen, app, Backbone, Marionette, $, _) {
    ...
    renderText = function(svg, model) {
      ...
      body = svg.text("E-mail: " + data.eMail + " \nТелефон: " + data.phone + " \nДолжность: " + data.position).leading(1.3).attr({
        width: 10
      }).move(20, 60).font({
        size: 20
      });
